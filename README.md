...
# Integration tests: cargo test --tests (tests/*.rs — integration, cli_binary, cli_parse_matrix, cli_all_value_enums, helpers_stress, cli_combos, prefs_file_roundtrip, app_sort_and_columns, …)
